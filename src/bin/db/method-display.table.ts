...
export async function insertMethodDisplay(methodId: string, text: string, imageFrom: string, copiesFrom: string, standardFrom: string): Promise<MethodDisplayTable> {
