...
export async function insertRegistryChange(address: string, type: 'like' | 'follow', action: 'add' | 'remove', value: string, date: Date): Promise<void> {
  await executeQuery('INSERT INTO "registry_change" VALUES ($1, $2, $3, $4, $5)', [address, type, action, value, date]);
}
