...
import {deleteAsset, insertAsset, queryAssets, queryAssetsByType} from "../../../lib/db/queries/asset.table";
...
export const AssetTests = () => {
  describe('Table AssetTable', () => {
      ...
      it ('should be able to insert values', async () => {
          assert(!await shouldThrow(insertAsset(UNIVERSAL_PROFILE_1, 'ipfs://123456789', 'exe', '0x8fd18994f98161fbe679d007e2021635b11a6d3225b8528737ec9e8618c57103')));
      });

      it ('should be able to query assets', async () => {
          await insertAsset(UNIVERSAL_PROFILE_1, 'ipfs://123456789', 'exe', '0x8fd18994f98161fbe679d007e2021635b11a6d3225b8528737ec9e8618c57103');
          ...
          expect(res[0].hash).to.be.equal('0x8fd18994f98161fbe679d007e2021635b11a6d3225b8528737ec9e8618c57103');
      });

      it ('should be able to query assets by type', async () => {
          await insertAsset(UNIVERSAL_PROFILE_1, 'ipfs://123456789', 'exe', '0x8fd18994f98161fbe679d007e2021635b11a6d3225b8528737ec9e8618c57103');
          await insertAsset(UNIVERSAL_PROFILE_2, 'ipfs://987654321', 'c4d', '0x34d23994f98161fbe679d007e2021635b11a6d3225b8528737ec9e8618c57103');
