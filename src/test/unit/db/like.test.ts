...
describe('Table LikeTable', () => {
  ...
  it('should be able to count post likes', async () => {
    ...
    const likes: number = await queryPostLikesCount(
      '0xb097de0f7a884906c66ef0c5f42d8a27ae841af2fa68a05343cd1333d2435428',
    );
  ...
  it('should be able to query a post like', async () => {
    ...
    const liked: boolean = await queryPostLike(
      UNIVERSAL_PROFILE_1,
      '0xb097de0f7a884906c66ef0c5f42d8a27ae841af2fa68a05343cd1333d2435428',
    );
    const liked2: boolean = await queryPostLike(
      UNIVERSAL_PROFILE_1,
      '0xb097de0f7a384906c66ef0c5f42d8a27ae841af2fa68a05343cd1333d2435428',
    );
    expect(liked).toEqual(true);
    expect(liked2).toEqual(false);
  });
  ...
  it('should be able to query post liked by a sender', async () => {
    ...
    expect(posts[0]).toEqual('0xb097de0f7a884906c66ef0c5f42d8a27ae841af2fa68a05343cd1333d2435428');
  });
