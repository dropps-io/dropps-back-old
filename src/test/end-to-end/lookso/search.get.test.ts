  ...
  describe('GET lookso/search/:input', () => {
    ...
    describe ('With pagination', () => {
      ...
      it ('should return the transaction if transaction hash as input', async () => {
        ...
        expect(payload.search.transactions.results[0].from).to.equal(web3.utils.toChecksumAddress('0x24b04685eff4dbcc6382715c73f4a61566d4967e'));
        expect(payload.search.transactions.results[0].to).to.equal(web3.utils.toChecksumAddress('0x42d6fe6eb3fc1e5585ab958fb77780327991781b'));
