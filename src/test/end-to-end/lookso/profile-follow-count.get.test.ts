...
export const ProfileFollowCountGETTests = () => {
  ...
  describe('GET lookso/profile/:address/following/count', () => {
    ...
    it('should return 200', async () => {
      const res = await fastify.inject({method: 'GET', url: `/lookso/profile/${HACKER_MAN_UP}/following/count`});
    ...
    it('should return the right following count', async () => {
      ...
      const res2 = await fastify.inject({method: 'GET', url: `/lookso/profile/${UNIVERSAL_PROFILE_2}/following/count`});
  ...
  describe('GET /profile/:address/followers/count', () => {
    ...
    it('should return 200', async () => {
      const res = await fastify.inject({method: 'GET', url: `/lookso/profile/${HACKER_MAN_UP}/followers/count`});
      expect(res.statusCode).to.equal(200);
    });
    ...
    it('should return the right following count', async () => {
      ...
      const res2 = await fastify.inject({method: 'GET', url: `/lookso/profile/${UNIVERSAL_PROFILE_2}/followers/count`});
