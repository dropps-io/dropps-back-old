...
import { ContractInterfaceTable } from '../../../api/src/models/types/tables/contract-interface-table';
import { queryContractInterfaces } from '../../../api/src/lib/db/queries/contract-interface.table';
