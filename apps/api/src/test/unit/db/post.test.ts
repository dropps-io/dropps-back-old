...
describe('Table Post', () => {
  ...
  it('should be able to query values with postHash', async () => {
    ...
    expect(post.hash).toEqual('0xb097de0f7a884906c66qw0c5f42d8a27ae841af2fa68a05343cd1333d2435428');
    expect(post.author).toEqual(UNIVERSAL_PROFILE_1);
    expect(post.date.toDateString()).toEqual(date.toDateString());
    expect(post.text).toEqual('Text');
    expect(post.mediaUrl).toEqual('url');
  });
});
