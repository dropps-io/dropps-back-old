...
describe('Generate new registry from changes', () => {
  it('should handle correctly duplicates add changes', () => {
    ...
    expect(newRegistry.follows.length).toEqual(1);
    expect(newRegistry.follows[0]).toEqual('bob');
    expect(newRegistry.likes.length).toEqual(1);
    expect(newRegistry.likes[0]).toEqual('post');
  });
  ...
  it('should handle correctly duplicates remove changes', () => {
    ...
    expect(newRegistry.follows.length).toEqual(0);
    expect(newRegistry.likes.length).toEqual(0);
  });
