...
import { insertContractInterface } from '../../apps/api/src/lib/db/queries/contract-interface.table';
import ERC721 from '../../apps/api/src/assets/artifacts/ERC721PresetMinterPauserAutoId.json';
import ERC777 from '../../apps/api/src/assets/artifacts/ERC777PresetFixedSupply.json';
import ERC20 from '../../apps/api/src/assets/artifacts/ERC20PresetMinterPauser.json';
import ERC1155 from '../../apps/api/src/assets/artifacts/ERC1155PresetMinterPauser.json';
