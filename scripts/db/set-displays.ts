import { insertMethodDisplay } from '../../apps/api/src/lib/db/queries/method-display.table';
import { executeQuery } from '../../apps/api/src/lib/db/queries/database';
import { insertKeyDisplay } from '../../apps/api/src/lib/db/queries/key-display.table';
import { insertMethodParameterDisplayType } from '../../apps/api/src/lib/db/queries/method-parameter.table';
import { setErc725ySchemaValueDisplay } from '../../apps/api/src/lib/db/queries/erc725y-schema.table';
